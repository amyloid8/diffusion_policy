...
from diffusion_policy.env.pusht.pusht_rel_keypoints_env import PushTRelKeypointsEnv
import pygame
...
def main(output, render_size, control_hz):
    ...
    kp_kwargs = PushTRelKeypointsEnv.genenerate_keypoint_manager_params()
    env = PushTRelKeypointsEnv(render_size=render_size, render_action=False, **kp_kwargs)
